 ...
 *
 * Low-level protocol implementation for building and parsing Moteus CAN frames.
 * Based on the multiplex protocol specification.
 *
 * Invariants/assumptions:
 * - Callers provide a correct CAN ID (29-bit extended) generated by this module's
 *   CAN-ID helpers.
 * - Frame payload is treated as an ordered byte stream immediately following the
 *   CAN ID.
 * - Float values are encoded/decoded as IEEE-754 32-bit floats, little-endian.
 * - Resolution selection affects both encoding precision and the number of bytes
 *   consumed/emitted.
 *
